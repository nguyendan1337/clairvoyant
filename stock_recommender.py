...
def call_gemini(client, gemini_config, prompt):
...
def update_html_page(final_recommendations, all_etfs_table):
...
reduced_list = call_gemini(client, gemini_config, prompt_selection)
print("GEMINI RESPONSE:\n")
print(reduced_list)

prompt_recommendation = config["prompt_recommendation"] + reduced_list
final_recommendations = call_gemini(client, gemini_config, prompt_recommendation)
...
update_html_page(final_recommendations, all_etfs_table)